...
public class WifiWatchdogStateMachine extends StateMachine {
     ...
     */
    private static long mLinkSamplingIntervalMs;
     ...
     * These parameters should be tuned along with {@link #mLinkSamplingIntervalMs}.
     */
     ...
     */
    private static final double POOR_LINK_MIN_VOLUME = 2.0 * mLinkSamplingIntervalMs / 1000.0;
    ...
    private void updateLinkSamplingInterval() {
        ...
        try {
          ...
          Log.e("MaybeService-LinkSamplingIntervalMs", "Failed to get maybe service.", e);
          return;
        };
        ...
        switch (__LinkSamplingIntervalMs__879) {
          ...
          case 2: {
                    mLinkSamplingIntervalMs = 5000;
                    break;
          }  
          case 1: {
                    mLinkSamplingIntervalMs = 2000;
                    break;
          }  
          default: {
        ...
        public boolean processMessage(Message msg) {
            switch (msg.what) {
                ...
                case WifiManager.RSSI_PKTCNT_FETCH_SUCCEEDED:
                    ...
                    if (now - mCurrentBssid.mLastTimeSample < mLinkSamplingIntervalMs * 2) {
