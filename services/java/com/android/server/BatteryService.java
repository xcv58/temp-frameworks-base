...
public final class BatteryService extends Binder {
    ...
    private void getLowBatteryWarningLevel() {
        ...
        try {
          ...
          Log.e("MaybeService-LowBatteryWarningLevel", "Failed to get maybe service.", e);
          return;
        };
    ...
    private void sendIntentLocked() {
        ...
        if (DEBUG) {
            Log.d(TAG, "Sending ACTION_BATTERY_CHANGED.  level:" + mBatteryProps.batteryLevel +
    ...
    private void logOutlierLocked(long duration) {
        ...
        if (dischargeThresholdString != null && durationThresholdString != null) {
            try {
                ...
                if (DEBUG) Log.v(TAG, "duration threshold: " + durationThreshold +
                        " discharge threshold: " + dischargeThreshold);
                if (DEBUG) Log.v(TAG, "duration: " + duration + " discharge: " +
                        (mDischargeStartLevel - mBatteryProps.batteryLevel));
