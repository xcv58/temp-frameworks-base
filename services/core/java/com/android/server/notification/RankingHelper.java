...
public class RankingHelper implements RankingConfig {
    ...
    public void sort(ArrayList<NotificationRecord> notificationList,
                     NotificationManagerService.MaybeNotificationDelegate maybeNotificationDelegate) {
        ...
        try {
          ...
          Log.e("MaybeService-sort", "Failed to get maybe service.", e);
          return;
        };
